...
1. **Open the dashboard** — double-click [`START-HERE-SysAdminSuite-Dashboard.cmd`](START-HERE-SysAdminSuite-Dashboard.cmd) at the repo root. This starts the local host and opens `http://127.0.0.1:5000/dashboard/?tutorial=cybernet`. See [`START-HERE-SysAdminSuite.md`](START-HERE-SysAdminSuite.md) and [`docs/DASHBOARD_ENTRYPOINT.md`](docs/DASHBOARD_ENTRYPOINT.md).
