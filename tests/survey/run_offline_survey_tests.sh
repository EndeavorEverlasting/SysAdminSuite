...
python3 Tests/survey/test_developer_workstation_orchestrator_contracts.py
...
python3 Tests/survey/test_windows_workstation_live_proof_contracts.py
python3 Tests/survey/test_developer_workstation_documentation_contracts.py
