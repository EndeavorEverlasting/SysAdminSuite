...
3. Inspect the diff for local paths, usernames, hostnames, serials, MACs, and live artifact names.
4. Keep evidence in workflow-approved ignored paths.
5. Confirm staged files contain only sanitized tracked material.
