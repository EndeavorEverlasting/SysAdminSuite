...
Describe 'Northwell printer mapping evidence precedence contract' {
    ...
    It 'keeps operator evidence discoverable without bloating the quick launcher or printing another test page' {
        ...
        $launcher | Should -Match 'Confirm-NorthwellPrinterActiveUserMaterializationResilient\.ps1'
        $launcher | Should -Not -Match '-File "%~dp0mapping\\Confirm-NorthwellPrinterActiveUserMaterialization\.ps1"'
