...
This PR keeps its contract suite focused on fixture-backed reports, command-surface wrappers, schemas, workflow specs, documentation indexes, launcher surfaces, worktree bootstrap, and local harness validation surfaces.
