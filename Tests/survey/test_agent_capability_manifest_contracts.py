...
REQUIRED_SKILL_IDS={'repository-sprint','language-runtime','field-workflow','scoped-validation','end-to-end-validation','live-data-guard','survey-low-noise','developer-workstation','ai-provider-catalog','agent-feedback'}
