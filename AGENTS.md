...
not a new PowerShell script. The PowerShell equivalents in `GUI/Start-SysAdminSuiteGui.ps1` and
`GetInfo/Convert-DeploymentTrackerToTargets.ps1` remain and are not removed.
