...
(function () {
  ...
  // qrcode@1.5.4 npm tarball does not ship build/qrcode.min.js; 1.5.1 is the last CDN build artifact.
  const QR_CDN_LIB = 'https://cdn.jsdelivr.net/npm/qrcode@1.5.1/build/qrcode.min.js';
