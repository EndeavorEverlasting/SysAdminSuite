# Harvest: sprint/2026-05-03-docs-shell-contract

- Source ref: `origin/sprint/2026-05-03-docs-shell-contract`
...
5e11afc (origin/sprint/2026-05-03-docs-shell-contract) docs: add approved command catalog
b774990 docs: define AI runtime contract
9936ac9 docs: add agent runtime guardrails
39e95cb (grafted) Merge Bash deployment audit and transport hardening
1bb0878 CI: add Windows Pester workflow; README: clarify main as primary branch.
2b96589 Tests: make Pester 5 suite green and harden CI assumptions.
04d9789 Tests: add Pester 5 suite entrypoint and docs.
```
