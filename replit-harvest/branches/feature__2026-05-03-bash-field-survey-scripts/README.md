# Harvest: feature/2026-05-03-bash-field-survey-scripts

- Source ref: `origin/feature/2026-05-03-bash-field-survey-scripts`
...
7519501 (origin/feature/2026-05-03-bash-field-survey-scripts) docs: add Bash field survey quickstart
b2b4883 test: add Bash-on-Windows runtime smoke test
43f7077 feat: add Neuron environment survey wrapper
8d4c1a2 feat: add Bash-on-Windows device snapshot survey
