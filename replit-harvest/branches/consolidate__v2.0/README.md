# Harvest: consolidate/v2.0

- Source ref: `origin/consolidate/v2.0`
...
484116c (origin/consolidate/v2.0) feat: UTF-8 BOM Sync GUI tab + launcher bat + fix BMP char warning
5a4dabe Fix Run.log file lock crash, show artifact paths in status pane after run completes
1c7ad6d Replace linear tutorial with menu-based 6-track system, preserve green/red button identity during highlights
867216e Add example output walkthrough to tutorial, enlarge panel, update README with GUI launch guide
be8ef9e Harden Kronos and machine-info output contracts
3d3ca0c Add GUI run launches and controller worker args
```
