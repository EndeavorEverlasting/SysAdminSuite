# Harvest: feature/2026-04-30-bash-sysadminsuite-neuron-merge

- Source ref: `origin/feature/2026-04-30-bash-sysadminsuite-neuron-merge`
...
1da946d (origin/feature/2026-04-30-bash-sysadminsuite-neuron-merge) Add Neuron software reference 11.8.0.328
d21bbca Add Neuron observed packages example from 2026-04-29 branch
702967e Merge 2026-04-29 Neuron maintenance tooling into 2026-04-30 Bash branch
070a869 (origin/feature/2026-04-29-neuron-maintenance-tooling) feat: add default neuron baseline config
82be0cd feat: register neuron maintenance QR task
2493639 feat: add neuron maintenance snapshot task
```
