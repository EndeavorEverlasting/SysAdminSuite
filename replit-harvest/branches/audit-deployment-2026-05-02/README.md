# Harvest: audit-deployment-2026-05-02

- Source ref: `origin/audit-deployment-2026-05-02`
...
12c8262 (origin/audit-deployment-2026-05-02) Document SMB read-only recon adapter
31daef7 Test SMB read-only recon contracts
824b9c8 Add SMB admin-share read-only recon adapter
aeeced3 Document optional WMI identity transport
2616c0b Test optional WMI identity adapter contracts
ef4cd9f Wire optional WMI transport into workstation identity adapter
```
