# Harvest: feature/2026-04-29-neuron-software-reference

- Source ref: `origin/feature/2026-04-29-neuron-software-reference`
...
44cc440 (origin/feature/2026-04-29-neuron-software-reference) Document Neuron software reference workflow
18746e3 Add example observed Neuron package snapshot
41b605b Add Neuron software reference checker
5cb5782 Add Neuron software reference baseline 11.8.0.328
b4cf730 Add Neuron network inventory survey tooling
eeecb12 Add managed .NET foundation, xUnit tests, and runtime policy docs
```
