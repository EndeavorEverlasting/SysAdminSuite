# Harvest: docs/2026-05-03-bash-windows-runtime-contract

- Source ref: `origin/docs/2026-05-03-bash-windows-runtime-contract`
...
7cff89f (origin/docs/2026-05-03-bash-windows-runtime-contract) docs: add Bash-on-Windows command catalog
d8abd62 docs: add Bash-on-Windows runtime contract
79ae99b docs: tighten agent Bash-on-Windows guardrails
