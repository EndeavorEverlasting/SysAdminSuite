# Harvest: feature/2026-04-27-maintenance-status-harness

- Source ref: `origin/feature/2026-04-27-maintenance-status-harness`
...
1e8874a (origin/feature/2026-04-27-maintenance-status-harness) Add Neuron inventory script contract tests
b67e553 Add Neuron inventory target template
fcc707d Add Neuron network inventory survey tooling
ba19edb Add HTML summary cards to maintenance fleet report
18fc975 Fix C$ SUPPORT path and document Akbarnator hub assumption
22ace42 Add SUPPORT share fallback staging strategy
```
