# Harvest: unit-tests/repo-health-and-bom-compliance

- Source ref: `origin/unit-tests/repo-health-and-bom-compliance`
...
ca09a27 (origin/unit-tests/repo-health-and-bom-compliance) GUI: offline QR in Machine Info, docs, and tests
2d1889f Add GUI tests for QR display workflow
ca505f5 Add confidence and universal HTML to OCR parsers
bbf2169 Add experimental OCR map parser foundation
0b7bc45 Fix monitor HTML export return contract
5d280bd Improve GUI QR discoverability across result views
```
