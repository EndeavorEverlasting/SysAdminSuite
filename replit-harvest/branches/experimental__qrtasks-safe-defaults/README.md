# Harvest: experimental/qrtasks-safe-defaults

- Source ref: `origin/experimental/qrtasks-safe-defaults`
...
8772786 Add overview page and server to document SysAdmin toolkit
39e95cb (grafted) Merge Bash deployment audit and transport hardening
f318f36 (origin/experimental/qrtasks-safe-defaults) feat: add localhost fallback when network share is unreachable
9fc972f docs: replace hallucinated hostname with safe <YOUR-HOST> placeholder in QRTasks examples
dce9776 feat: add QRTasks scan-to-run extension module
c078323 (origin/demo/v2.1) feat: add splash screen, Harold icon, RAM/Monitor/Zebra to Machine Info dropdown, fix SetUnhandledExceptionMode crash
8f8bed6 fix: harden GUI against Ctrl+C PipelineStoppedException crash
a949e8c chore: add Get-RamInfo, MonitorInfo enhancements, GUI polish, BOM fix — 110/110 tests green
```
