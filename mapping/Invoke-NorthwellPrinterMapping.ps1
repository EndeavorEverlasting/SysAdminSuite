...
function Write-RunSummary {
    ...
    [ordered]@{
        ...
        ProofLevel = 'MACHINE_WIDE_REGISTRATION'
...
Write-ControllerLog 'Proof: this engine proves machine-wide registration. A later real document print is separate runtime acceptance evidence.'
Write-RunSummary
