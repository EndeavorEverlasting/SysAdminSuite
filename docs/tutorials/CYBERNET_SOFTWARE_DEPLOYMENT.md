...
`--allow-legacy` activates this preserved deployment lane. It does not supply authorization, credentials, target scope, or acceptance.
...
1. Passes the network and legacy-lane gates.
