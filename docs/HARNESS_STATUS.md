...
- **Harness CI:** `.github/workflows/harness-registry-integrity.yml` runs registry integrity, completeness, report rendering, hook/offline-runner syntax, and whitespace checks whenever registry-facing harness files change.
