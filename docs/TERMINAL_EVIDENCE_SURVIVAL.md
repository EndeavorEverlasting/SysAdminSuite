...
A field terminal is a display surface, not the evidence store. SysAdminSuite treats terminal lifetime and evidence lifetime as separate concerns and routes the AutoLogon field command through the already-merged crash-safe front door.
