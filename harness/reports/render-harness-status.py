...
def render() -> str:
    ...
    lines = [
        ...
        "Schema: `sas-harness-status-report/v1`", "", "## Summary", "",
    ...
    lines.append("Required-component inventory is **not complete**; see Missing below." if missing else "All required component paths declared by the operational harness manifest are present in this checkout.")
    lines += ["", "## Blocking validator floor", ""]
    ...
    lines += [
        "", "## Proof ceiling", "", manifest["proof_ceiling"], "",
