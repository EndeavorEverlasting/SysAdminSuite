...
Write-Host "  START-HERE-SysAdminSuite-Dashboard.bat   (canonical)"
Write-Host "  START-HERE-SysAdminSuite-Dashboard.cmd   (compatibility alias)"
Write-Host "  SysAdminSuite Dashboard.cmd              (compatibility alias)"
Write-Host ""
Write-Host "Requires .NET 8 runtime on the workstation."
Write-Host "See docs/DASHBOARD_ENTRYPOINT.md and docs/DASHBOARD_EXE_FUTURE_SPRINT.md."
